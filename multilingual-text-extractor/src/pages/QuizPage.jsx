...
export default function QuizPage() {
  ...
  if (error) return <div style = {styles.body2}>
    <header style={styles.header}>
        ...
        <nav>
          ...
          <Link to="/SelectPage" style={{ ...styles.navLink, ...styles.activeLink }}>Upload an Image</Link>
        </nav>
    </header>
  ...
  return (
    <div style={styles.body}>
      <header style={styles.header}>
        <div style={{ display: "flex", alignItems: "center" }}>
          <h3 style={{ margin: 0 }}>Text Extractor</h3>
        </div>
        <nav>
          <Link to="/" style={styles.navLink}>Home</Link>
          <Link to="/SelectPage" style={{ ...styles.navLink, ...styles.activeLink }}>Upload an Image</Link>
        ...
        {questions.length === 0 ? (
          <div style={styles.uploadCard}>
              ...
              {!imagePath ? (
                <>
                  ...
                  <p style={{ ...styles.uploadText, opacity: 0.8, fontSize: "0.9rem" }}>
                    Supports JPG, PNG, or JPEG files
                  </p>
                  <input 
                    type="file" 
            ...
            <div style={{ marginBottom: "1rem" }}>
                <label htmlFor="languageSelect" style={{ color: "#FDE8E9", marginRight: "0.5rem" }}>Select OCR Language:</label>
                <select
                    id="languageSelect"
